# BusyBits Sponsorship Outreach Drafts (Tier 1: Health Tech)

**Strategy:** "The Super-User Angle"
**Goal:** Book Q2 Sponsorships ($2.5k - $5k per slot).
**Sender:** Ziga (Founder, BusyBits - 100k Subs).
...
I’ve been sleeping on the Pod for [Time] and it’s the single highest-ROI hardware I own. My deep sleep numbers went from [X] to [Y] in the first week.
...
## Usage Guide
1.  **Find Emails:** Use Apollo.io / Hunter.io.
2.  **Send:** Tuesday/Wednesday/Thursday AM (9-11am EST).
3.  **Follow Up:** 3 Days later ("Bump").
4.  **Follow Up 2:** 7 Days later ("Last try for now").
